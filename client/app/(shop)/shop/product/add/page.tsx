...
const styles: Record<string, React.CSSProperties> = {
  ...
  inputWrapper: {
    ...
    background: "#e8f0f7", borderRadius: 6, overflow: "hidden",
  },
  inputPrefix: {
    padding: "12px 12px", fontSize: 14,
    color: "#888", background: "#e8f0f7",
  },
  inputWithPrefix: {
    flex: 1, border: "none", background: "#e8f0f7",
    padding: "12px 14px 12px 0", fontSize: 14, outline: "none",
  },
